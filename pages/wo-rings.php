...
// جلب المنتجات الخاصة بقسم "خواتم نسائية" عن طريق slug = wo-rings
$stmt = $pdo->prepare("SELECT p.* FROM products p JOIN categories c ON p.category_id = c.id WHERE c.slug = 'wo-rings' ORDER BY p.id DESC");
$stmt->execute();
...
?>
    ...
    <div class="additional-content">
        <div class="shop-header">
            <h1>خواتم نسائية</h1>
            <p>تشكيلة فاخرة من الخواتم النسائية | اضغط على <span class="info-badge">ⓘ</span> لقراءة الوصف التفصيلي</p>
        </div>
