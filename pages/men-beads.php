...
// جلب المنتجات الخاصة بقسم "مسابح" عن طريق slug = men-beads
$stmt = $pdo->prepare("SELECT p.* FROM products p JOIN categories c ON p.category_id = c.id WHERE c.slug = 'men-beads' ORDER BY p.id DESC");
$stmt->execute();
...
?>
    ...
    <div class="additional-content">
        <div class="shop-header">
            <h1>مسابح</h1>
            <p>تشكيلة فاخرة من المسابح العقيق والفضة | اضغط على <span class="info-badge">ⓘ</span> لقراءة الوصف التفصيلي</p>
        </div>
