...
// جلب المنتجات الخاصة بقسم "أقراط نسائية" عن طريق slug = wo-earrings
$stmt = $pdo->prepare("SELECT p.* FROM products p JOIN categories c ON p.category_id = c.id WHERE c.slug = 'wo-earrings' ORDER BY p.id DESC");
$stmt->execute();
...
?>
    ...
    <div class="additional-content">
        <div class="shop-header">
            <h1>أقراط نسائية</h1>
            <p>تشكيلة فاخرة من الأقراط | اضغط على <span class="info-badge">ⓘ</span> لقراءة الوصف التفصيلي</p>
        </div>
