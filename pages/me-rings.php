...
// جلب المنتجات الخاصة بقسم "خواتم رجالية" عن طريق slug = me-rings
$stmt = $pdo->prepare("SELECT p.* FROM products p JOIN categories c ON p.category_id = c.id WHERE c.slug = 'me-rings' ORDER BY p.id DESC");
$stmt->execute();
...
?>
    ...
    <div class="additional-content">
        <div class="shop-header">
            <h1>   خواتم رجالية</h1>
            <p>تشكيلة فاخرة من الخواتم  الرجالية   | اضغط على <span class="info-badge">ⓘ</span> لقراءة الوصف التفصيلي</p>
        </div>
