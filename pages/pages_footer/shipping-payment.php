    ...
    <div class="page-content">
        ...
        <div class="method-card">
            ...
            <div class="method-text">
                <h3>1. تطبيق توصيل</h3>
                <p>التوصيل السريع لطلبك عبر تطبيق توصيل. يتم حساب التكلفة آلياً بناءً على موقعك.</p>
            </div>
        </div>
        <div class="method-card">
            <div class="method-icon"><i class="fas fa-motorcycle"></i></div>
            <div class="method-text">
                ...
                <p>التوصيل الموثوق لطلبك عبر تطبيق تساهيل. يتم حساب التكلفة آلياً بناءً على موقعك.</p>
            </div>
        </div>
        <div class="method-card">
            ...
            <div class="method-text">
                <h3>3. تطبيق ناس</h3>
                <p>استلم طلبك عبر تطبيق ناس لضمان أفضل خدمة. يتم حساب التكلفة آلياً بناءً على موقعك.</p>
            </div>
        </div>
        ...
        <div class="note" style="background: rgba(11, 27, 43, 0.05); border-right: 4px solid #0B1B2B;">
            ...
            عند إتمام طلبك في المتجر، يقوم النظام آلياً باحتساب رسوم التوصيل المبدئية. بعد تأكيد الطلب، يقوم فريقنا بتجهيز المنتج، ثم يتم طلب مندوب عبر إحدى تطبيقات التوصيل المعتمدة لدينا (توصيل، تساهيل، أو ناس). سيتواصل معك المندوب ويتوجه مباشرة إلى موقعك لتسليم الطلب.
        </div>
        ...
        <div class="method-card">
            ...
            <div class="method-text">
                ...
                - ون كاش<br>
                - فلوسك<br>
                <em>(رقم نقطة المتجر للتحويل هو: <strong>560570</strong> أو لمشترك <strong>771771813</strong>)</em></p>
            </div>
        </div>
        ...
        <table>
            ...
            <tr><td>توصيل مباشر لموقعك</td><td>تُحسب آلياً أثناء الطلب بناءً على المسافة</td><td>سريع جداً (نفس اليوم)</td></tr>
        </table>
