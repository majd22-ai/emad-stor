...
\restrict t1Hix7kodrGIKqlNf6M37RyMW9cGSeUEkkB8b7Y9237IcLJEkJkTRpHYfqlLkBF
...
CREATE TABLE public.orders (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    payment_method character varying(100) DEFAULT '╪د┘╪»┘╪╣ ╪╣┘╪» ╪د┘╪د╪│╪ز┘╪د┘à'::character varying,
    shipping_method character varying(100) DEFAULT '╪ز┘ê╪╡┘è┘'::character varying,
...
CREATE TABLE public.users (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    oauth_provider character varying(50) DEFAULT NULL::character varying,
...
\unrestrict t1Hix7kodrGIKqlNf6M37RyMW9cGSeUEkkB8b7Y9237IcLJEkJkTRpHYfqlLkBF
